/* @ts-self-types="./ckb_keyvault_wasm.d.ts" */
 ...
 * @returns {Uint8Array}
 */
function change_password(blob, old, _new) {
    const ptr0 = passArray8ToWasm0(blob, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(old, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(_new, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.change_password(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[3]) {
 ...
 * @returns {Uint8Array}
 */
function derive_lock_args(blob, password, index) {
    const ptr0 = passArray8ToWasm0(blob, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(password, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.derive_lock_args(ptr0, len0, ptr1, len1, index);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
...
exports.derive_lock_args = derive_lock_args;
 ...
 * @returns {Uint8Array}
 */
function export_seed_phrase(blob, password) {
    const ptr0 = passArray8ToWasm0(blob, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(password, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.export_seed_phrase(ptr0, len0, ptr1, len1);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
exports.export_seed_phrase = export_seed_phrase;
 ...
 * @returns {any}
 */
function generate_master_seed(password) {
    const ptr0 = passArray8ToWasm0(password, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.generate_master_seed(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
}
exports.generate_master_seed = generate_master_seed;
 ...
 * @returns {Uint8Array}
 */
function import_seed_phrase(mnemonic, password) {
    const ptr0 = passArray8ToWasm0(mnemonic, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(password, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.import_seed_phrase(ptr0, len0, ptr1, len1);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
exports.import_seed_phrase = import_seed_phrase;
 ...
 * @returns {number}
 */
function password_entropy_bits(password) {
    const ptr0 = passArray8ToWasm0(password, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.password_entropy_bits(ptr0, len0);
    return ret >>> 0;
}
exports.password_entropy_bits = password_entropy_bits;
 ...
 * @returns {Uint8Array}
 */
function sign_digest(blob, password, index, digest) {
    const ptr0 = passArray8ToWasm0(blob, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(password, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(digest, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.sign_digest(ptr0, len0, ptr1, len1, index, ptr2, len2);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v4 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
exports.sign_digest = sign_digest;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./ckb_keyvault_wasm_bg.js": import0,
    };
}
...
const wasmPath = `${__dirname}/ckb_keyvault_wasm_bg.wasm`;
